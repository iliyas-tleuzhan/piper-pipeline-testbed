...
def main() -> int:
    ...
    result = {
        ...
        "combined_trajectory_request": {
            ...
            "maximum_total_tcp_displacement_m": trajectory_plan.total_requested_tcp_displacement_m,
            "maximum_adjacent_waypoint_translation_m": trajectory_plan.maximum_adjacent_waypoint_translation_m,
            "configured_total_translation_limit_m": trajectory_plan.configured_total_translation_limit_m,
            "configured_adjacent_waypoint_limit_m": trajectory_plan.configured_adjacent_waypoint_limit_m,
            ...
            "horizon_truncated": trajectory_plan.horizon_truncated,
        },
