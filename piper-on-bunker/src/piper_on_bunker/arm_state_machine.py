...
ALLOWED_TRANSITIONS = {
    ...
    ArmMode.WAITING_FOR_VERIFICATION: {ArmMode.VERIFYING, ArmMode.RETRACTING, ArmMode.NAVIGATION_VIEW, ArmMode.FAULT, ArmMode.ESTOP},
    ArmMode.VERIFYING: {ArmMode.RETRACTING, ArmMode.NAVIGATION_VIEW, ArmMode.FAULT, ArmMode.ESTOP},
    ArmMode.RETRACTING: {ArmMode.WAITING_FOR_VERIFICATION, ArmMode.VERIFYING, ArmMode.NAVIGATION_VIEW, ArmMode.STOWED, ArmMode.FAULT, ArmMode.ESTOP},
