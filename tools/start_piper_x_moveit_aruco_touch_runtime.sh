...
tmux new-window -t "$SESSION" -n joint_relay "docker exec -i $CONTAINER bash -lc '$ROS_PREFIX python3 /root/piper-pipeline-testbed/piper-on-bunker/scripts/relay_piper_x_arm_joint_states.py --input-topic /joint_states_single --output-topic /joint_states'"
